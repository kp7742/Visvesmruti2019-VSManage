...
class APIPayingCheck(private val activity: Activity) : AsyncTask<Void, Void, String>() {
    ...
    override fun onPreExecute() {
        ...
        dialog!!.setMessage("Checking Paying Amount...")
    ...
    override fun doInBackground(vararg voids: Void): String? {
        ...
        val request = Request.Builder()
                .url("https://visvesmruti.tech/api/campaigner/details/")
                .post(formBody)
                .build()
